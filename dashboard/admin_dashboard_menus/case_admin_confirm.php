...
<body>
		...
		<div class="content">
		    ...
		    <form action="case_admin_confirm_later.php" method="POST" >
				<h2>Assign Case</h2>
					...
					<div class="form-row">
		    			...
		    			<div class="col">
		    				<label for="vid">Victim Id</label>
		      				<input type="text" class="form-control" placeholder="Victim id" name="vid" value="<?php echo $row['vid']; ?>" >
		    			</div>
		  			</div>      	
		       </div>
					...
					<div class="form-row">
		    			<div class="col">
		    				<label for="ioid">Investigation Officer Id</label>
		      				<input type="text" class="form-control" placeholder="IO id" name="ioid" required="required">
		    			</div>
		    			<div class="col">
		    				<label for="a_id">Accused/Suspect Id</label>
		      				<input type="text" class="form-control" placeholder="Accused Id" name="a_id" >
		    			</div>
		  			</div>      	
		       </div>
		       ...
		       <div class="form-group">
		       	<label for="subject">Subject</label>
		        	<input type="text" class="form-control" name="subject" placeholder="subject" required="required" value="<?php echo $row['subject']; ?>" >
		        </div>
					...
					<div class="form-row">
		    			<div class="col">
		    				<label for="i_date">Incident Date</label>
		      				<input type="date" class="form-control" placeholder="Incident Date" name="i_date" value="<?php echo $row['i_date']; ?>" >
		    			</div>
					...
					<div class="form-row">
		    			<div class="col">
		    				<label for="f_date">FIR Submit Date</label>
		      				<input type="date" class="form-control" placeholder="FIR Submit Date" name="f_date" value="<?php echo $row['f_date']; ?>" >
		    			</div>
		    			<div class="col">
		    				<label for="f_time">FIR Submit Time</label>
		      				<input type="time" class="form-control" placeholder="FIR Submit Time" name="f_time" value="<?php echo $row['f_time']; ?>" >
		    			</div>
		       ...
		       <div class="form-group">
		       	<label for="f_date">Case Details</label>
		        	<textarea  style="resize: vertical; width: 538px; height: 150px" class="form-control" name="c_details" > 
