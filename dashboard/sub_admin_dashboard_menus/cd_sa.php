...
<head>
	...
	<!-- Vanilla css -->
	<link rel="stylesheet" type="text/css" href="cd_sa_style.css">
</head>
<body>
			...
			<div class="card bg-light my-5 mx-auto" style="max-width: 50rem; ">
				<div class="card-header align-middle ">
					...
					<p class="float-right align-middle">
						<a href="view_cd.php?edit=<?php echo $fid ?>"><button type="button" class="btn btn-primary">View Case-Diary</button></a>
					</p>
				</div>
