...
<?php  
       ...
       $rs=mysqli_query($con,"SELECT * FROM `accused_info` WHERE fid='$edit_record'");
...
?>	
			...
			<div class="card bg-light mx-auto my-5 " style="max-width: 40rem;">
				...
				<div class="card-body">
					<p>
				<b>FIR ID:</b> <?php echo $fid;  ?></i><br><br>
				<b>Accused ID:</b> <?php echo $a_id;  ?><br>
				<b>Accused Name:</b> <?php echo $a_name;  ?><br>
				<b>Accused Address:</b> <?php echo $a_address;  ?><br>
				<b>Chargesheet ID:</b> <?php echo $cs_id;  ?><br>
				...
				<p class="float-right text-center">
						...
						<a href="accused_sa.php"><button type="button" class="btn btn-outline-success" >Go To Previous Menu</button></a>
					</p>
