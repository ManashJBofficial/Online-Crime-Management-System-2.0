...
<?php  
		...
		$rs=mysqli_query($con,"SELECT * FROM `fir_status` WHERE vid='$vid'");
...
?>	
		<div class="card bg-light my-5 mx-auto " style="max-width: 40rem;">
				<div class="card-header align-middle ">
					...
					<h5>STATUS:</h5>  <?php echo $status;  ?><br><br>
					...
					<?php 
						if ($status == "accepted")
						{
							...
							<div class="text-center">
								<a href="case_status.php"><button type="button" class="btn btn-outline-info center-block">View Case Status</button></a>
							</div>
							<?php
						}
						else
